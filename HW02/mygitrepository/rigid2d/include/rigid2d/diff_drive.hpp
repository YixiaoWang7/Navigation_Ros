...
namespace rigid2d
{
    ...
    class DiffDrive
    {
        ...
        /// \brief reset the robot to the given position/orientation and all the private parameters
        void reset(Twist2D ps);

        /// \brief set the position and orientation of the diff model only
        void set_pose(Twist2D ps);
